  ...
  setup() {
    ...
    const popularServices = ref<Service[]>([
      ...
      },
      {
        ...
        price: '500 MZN',
        icon: 'brush',
        image: 'https://th.bing.com/th/id/OIP.4RVwznL_Vt-E_JJ2qN_4nwHaE8?w=260&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3',
      },
      {
        ...
        price: '800 MZN',
        icon: 'face',
        image: 'https://th.bing.com/th/id/OIP.DrbNOFjyZa4R3jXk2TSQBgHaFD?w=262&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3',
      },
      {
        name: 'Depilação',
        ...
        price: '300 MZN',
        icon: 'flash_on',
        image: 'https://www.inlaserhairremoval.com/storage/2024/06/30779-the-truth-about-waxing-down-there-pros-and-cons-to-know.jpg',
      },
      {
